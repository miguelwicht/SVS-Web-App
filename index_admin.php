	...
	var myScroll;
		$(document).ready(function(){
			...
			$("#admin").click(function(event){
				...
				$("#content").load("content/admin.php", function() { 
					...
					/*********************************************************************/
						...
						$('#newPlayer').ajaxForm(function() { 
              			  	alert("Neuen Spieler hinzugefügt!"); 
								$("#content").load("content/admin.php");
           				}); 
					
						$('#newGameday').ajaxForm(function() { 
	              			 alert("Neuer Spieltag hinzugefügt!"); 
							$("#content").load("content/admin.php");
	           			});
        				$('#newTeam').ajaxForm(function() { 
                			alert("Neue Mannschaft hinzugefügt!!"); 
                			$("#content").load("content/svs3_statistic_all.html");
            			}); 
...
<body>
	<div class="navbar">
		<ul>
			<li><a href="content/admin.php" id="admin" alt"Admin"><img src="resources/design/pencil.png" /></a></li>
